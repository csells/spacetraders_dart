...
String parameterToString(dynamic value) {
  ...
  if (value is ShipNavStatus) {
    return ShipNavStatusTypeTransformer().encode(value).toString();
  }
  if (value is ShipRole) {
    return ShipRoleTypeTransformer().encode(value).toString();
  }
