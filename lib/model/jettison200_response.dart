...
class Jettison200Response {
  /// Returns a new [Jettison200Response] instance.
  Jettison200Response({
    required this.data,
  });
  ...
  /// Returns a new [Jettison200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Jettison200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<Jettison200Response>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Jettison200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Jettison200Response> mapFromJson(dynamic json) {
    final map = <String, Jettison200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Jettison200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
