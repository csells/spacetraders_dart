...
class SellCargo201Response {
  /// Returns a new [SellCargo201Response] instance.
  ...
  /// Returns a new [SellCargo201Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SellCargo201Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SellCargo201Response>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SellCargo201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SellCargo201Response> mapFromJson(dynamic json) {
    final map = <String, SellCargo201Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SellCargo201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
