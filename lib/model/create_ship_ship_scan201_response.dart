...
class CreateShipShipScan201Response {
  /// Returns a new [CreateShipShipScan201Response] instance.
  ...
  /// Returns a new [CreateShipShipScan201Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateShipShipScan201Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateShipShipScan201Response(
        data: CreateShipShipScan201ResponseData.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static List<CreateShipShipScan201Response>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateShipShipScan201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateShipShipScan201Response> mapFromJson(dynamic json) {
    final map = <String, CreateShipShipScan201Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateShipShipScan201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
