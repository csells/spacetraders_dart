...
class PurchaseCargo201Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is PurchaseCargo201Response && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PurchaseCargo201Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PurchaseCargo201Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PurchaseCargo201Response>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PurchaseCargo201Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PurchaseCargo201Response.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
