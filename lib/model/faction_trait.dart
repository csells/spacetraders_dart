  ...
  FactionTraitSymbolEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'ANARCHIST':
          return FactionTraitSymbolEnum.ANARCHIST;
        case r'CONFLICTED':
          return FactionTraitSymbolEnum.CONFLICTED;
        case r'AUTHORITARIAN':
          return FactionTraitSymbolEnum.AUTHORITARIAN;
        case r'OLIGARCHICAL':
          return FactionTraitSymbolEnum.OLIGARCHICAL;
        case r'DYNASTIC':
          return FactionTraitSymbolEnum.DYNASTIC;
        case r'DEMOCRACTIC':
          return FactionTraitSymbolEnum.DEMOCRACTIC;
        case r'DECENTRALIZED':
          return FactionTraitSymbolEnum.DECENTRALIZED;
        case r'SMUGGLERS':
