...
class FactionTraitSymbolEnum {
  ...
  static const ANARCHIST = FactionTraitSymbolEnum._(r'ANARCHIST');
  static const CONFLICTED = FactionTraitSymbolEnum._(r'CONFLICTED');
  static const AUTHORITARIAN = FactionTraitSymbolEnum._(r'AUTHORITARIAN');
  static const OLIGARCHICAL = FactionTraitSymbolEnum._(r'OLIGARCHICAL');
  static const DYNASTIC = FactionTraitSymbolEnum._(r'DYNASTIC');
  static const DEMOCRACTIC = FactionTraitSymbolEnum._(r'DEMOCRACTIC');
  static const DECENTRALIZED = FactionTraitSymbolEnum._(r'DECENTRALIZED');
  ...
  FactionTraitSymbolEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'ANARCHIST': return FactionTraitSymbolEnum.ANARCHIST;
        case r'CONFLICTED': return FactionTraitSymbolEnum.CONFLICTED;
        case r'AUTHORITARIAN': return FactionTraitSymbolEnum.AUTHORITARIAN;
        case r'OLIGARCHICAL': return FactionTraitSymbolEnum.OLIGARCHICAL;
        case r'DYNASTIC': return FactionTraitSymbolEnum.DYNASTIC;
        case r'DEMOCRACTIC': return FactionTraitSymbolEnum.DEMOCRACTIC;
        case r'DECENTRALIZED': return FactionTraitSymbolEnum.DECENTRALIZED;
