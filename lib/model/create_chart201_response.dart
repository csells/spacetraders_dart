...
class CreateChart201Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateChart201Response &&
     other.data == data;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateChart201Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateChart201Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateChart201Response>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateChart201Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateChart201Response>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateChart201Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
