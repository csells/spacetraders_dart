...
class ShipyardShipTypesInner {
  ...
  /// Returns a new [ShipyardShipTypesInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShipyardShipTypesInner? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ShipyardShipTypesInner>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShipyardShipTypesInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShipyardShipTypesInner> mapFromJson(dynamic json) {
    final map = <String, ShipyardShipTypesInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShipyardShipTypesInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
