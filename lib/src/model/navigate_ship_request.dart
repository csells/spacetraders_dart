...
class NavigateShipRequest {
  /// Returns a new [NavigateShipRequest] instance.
  NavigateShipRequest({
  ...
  /// Returns a new [NavigateShipRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NavigateShipRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<NavigateShipRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NavigateShipRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NavigateShipRequest> mapFromJson(dynamic json) {
    final map = <String, NavigateShipRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NavigateShipRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
