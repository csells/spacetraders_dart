...
class GetContracts200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetContracts200Response &&
          other.data == data &&
          other.meta == meta;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetContracts200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetContracts200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
